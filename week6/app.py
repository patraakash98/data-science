...
class Student(db.Model):
    ...
    course=db.relationship("Course",backref='students',secondary='enrollment',cascade='all,delete')
...
class NotGivenError(HTTPException):
    def __init__(self,status_code,error_code,error_message):
        message={'error_code':error_code,"error_messsage":error_message}
...
class CourseApi(Resource):
    ...
    def post(self):
        ...
        if course is None:
            ...
            raise FoundError(statuscode=409)
...
class EnrollmentAPI(Resource):
    ...
    def post(self,student_id):
        ...
        if student:
            ...
            course=course=Course.query.filter(Course.course_id==course_id).first()
            if course:
